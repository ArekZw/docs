...
📐 Style.Tools is a browser widget for access to professional CSS optimization tools. 📐 Style.Tools is like _Dev Tools for CSS Optimization_.

The widget is created for the purpose of tailored website performance optimization. It enables to achieve perfect performance scores that are of value for SEO (search engine optimization).
...
Source: https://github.com/style-tools/browser-widget/blob/master/widget.js (849 Bytes)
